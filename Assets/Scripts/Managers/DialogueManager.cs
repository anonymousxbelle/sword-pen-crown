...
namespace Managers
{
...

    {
        ...
        public void AssignDialogueUI(GameObject box, TMP_Text dialogue, TMP_Text speaker, Image character, Button clicker)
        {
            dialogueBox = box;
        ...
        //INK METHODS:
         ...
         public void LoadInkStory(TextAsset inkFile)
        {
            if (inkFile == null)
            {
